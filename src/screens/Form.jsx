...
import {
  ...
  FormControl, FormControlLabel, FormGroup, FormLabel, Radio,
  Stack, TextField
} from '@mui/material';
import {
...
export const Form = () => {
  ...
  useEffect(() => {
    if (uid) {
      ...
      http.gql('/api/admin/graphql', data).then((data:any) => {
  ...
  const searchPeopleOnClick=()=>{
    http.post('/api/reniec', {code:o.people.code}, (h:any) => { delete h['Authorization']; return h; }).then((data) => {
      console.log(data);
    });
  }
